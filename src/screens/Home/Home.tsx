...
const Home = ({ navigation }: { navigation: any }) => {
  ...
  const services = [
    { key: "CAR_WASH", title: "Car Wash", icon: "car-sport-outline", color: '#007AFF' },
    { key: "CAR_POLISH", title: "Car Polish", icon: "color-palette-outline", color: '#007AFF' },
    { key: "INTERIOR_WASH", title: "Interior Wash", icon: "water-outline", color: '#007AFF' },
    { key: "CAR_SERVICE", title: "Car Service", icon: "construct-outline", color: '#007AFF' },
    { key: "TYRE_CARE", title: "Tyre Care", icon: "speedometer-outline", color: '#007AFF' },
  ];
